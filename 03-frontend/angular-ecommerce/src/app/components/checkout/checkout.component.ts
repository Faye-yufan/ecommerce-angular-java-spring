...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.beautyShopFormService.getCreditCardMonths(startMonth).subscribe(
      data => {
    ...
    this.beautyShopFormService.getCreditCardYears().subscribe(
      data => {
    ...
    */
    ...
    this.beautyShopFormService.getCountries().subscribe(
      data => {
  ...
  getStates(formGroupName: string) {
    ...
    this.beautyShopFormService.getStates(countryCode).subscribe(
      data => {
